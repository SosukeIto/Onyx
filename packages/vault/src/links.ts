import { basename, dirname, extname, fold, joinPath, maskCode, splitLines } from "./text";
 ...
 */
export function extractLinks(fromPath: string, body: string, lineOffset = 0): Link[] {
 ...
 */
export function resolveLink(index: VaultIndex, fromPath: string, target: string): string | null {
