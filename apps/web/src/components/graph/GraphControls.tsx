...
function Slider({ icon, label, min, max, step, value, digits, onChange }: SliderProps) {
  const id = useId();
  return (
...
export function GraphControls({
  ...
  return (
    <div className={cx("min-w-0", className)}>
      <PanelSection icon={<IconFilter size={16} strokeWidth={1.6} />} label="フィルタ">
        <Toggle
        ...
        />
        <Toggle
          icon={<IconUnresolved className="flex-none" size={16} strokeWidth={1.6} />}
          label="未作成ノートを表示"
          on={filters.unresolved}
          onToggle={() => toggle("unresolved")}
        />
        <Toggle
          icon={<IconOrphan className="flex-none" size={16} strokeWidth={1.6} />}
          label="孤立ノートを表示"
          on={filters.orphans}
      ...
      <PanelSection icon={<IconSliders size={16} strokeWidth={1.6} />} label="表示の調整">
        <Slider
          digits={1}
          icon={<IconNodeSize className="flex-none" size={16} strokeWidth={1.6} />}
          label="ノードサイズ"
          max={2}
          min={0.4}
        ...
        <Slider
          digits={0}
          icon={<IconDistance className="flex-none" size={16} strokeWidth={1.6} />}
          label="リンク距離"
          max={320}
          min={40}
        ...
        <Slider
          digits={1}
          icon={<IconRepulse className="flex-none" size={16} strokeWidth={1.6} />}
          label="反発力"
          max={2}
          min={0.2}
