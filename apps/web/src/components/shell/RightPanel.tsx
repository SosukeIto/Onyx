...
import { IconBacklink, IconGraph, IconInfo, IconList, IconUnresolved } from "@/components/icons";
  ...
  return (
    <div className="onyx-scroll min-h-0 min-w-0 flex-1 pb-6">
      <PanelSection
        ...
        label="アウトライン"
      >
        <Outline activeSlug={activeSlug} headings={headings} onSelect={onHeadingSelect} />
      </PanelSection>
